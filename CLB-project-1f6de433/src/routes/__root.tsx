...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ClubHub — Hệ thống quản lý câu lạc bộ" },
      {
        name: "description",
        content:
          "Hệ thống ERP tập trung quản lý câu lạc bộ trong trường học: tác vụ, sự kiện, thành viên, tuyển dụng và vinh danh.",
      },
      { name: "author", content: "ClubHub" },
      { property: "og:title", content: "ClubHub — Hệ thống quản lý câu lạc bộ" },
      {
        property: "og:description",
        content: "Quản lý tác vụ, sự kiện, thành viên và vinh danh câu lạc bộ trong một nền tảng.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,300;0,400;0,500;0,700;0,900&display=swap",
      },
